...
abstract class Fighter
{
    ...
    {
        // faire en sorte que la methode retourne la force multipliée par le niveau du combattant
    ...
    {
        // faire en sorte que la methode retourne la force dexterité par le niveau du combattant
